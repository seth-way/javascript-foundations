...
describe('dj', function () {
  ...
  it('should be able to create a playlist', function () {
    var skeletonSong = createSong(
      'Skeletons in the Closet Rock',
      'The Skeletal Band'
    );
  ...
  it('should be able to add songs to a playlist', function () {
    ...
    var updatedHolidayPlaylist = addSongToPlaylist(
      holidayPlaylist,
      funkyFrosty
    );
  ...
  it('should be able to play all the songs', function () {
    var rockinSong = createSong(
      "Rockin' Around the Christmas Treehouse",
      'The Yuletide Youth'
    );
    var shuffleSong = createSong(
      "Santa's Sleigh Ride Shuffle",
      'The Jolly Jinglesters'
    );
    var reggaeSong = createSong("Rudolph's Reggae Jam", 'The Reindeer Rhythms');

    var holidayPlaylist = makePlaylist('Holiday Songs', [
      rockinSong,
      shuffleSong,
      reggaeSong,
    ]);
  ...
  it('should play only the favorite songs when "favorites only" is specified', function () {
    ...
    var reggaeSong = createSong(
      "Rudolph's Reggae Jam",
      'The Reindeer Rhythms',
      true
    );
